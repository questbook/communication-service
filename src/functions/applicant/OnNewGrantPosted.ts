...
import { OnNewGrantPostedDocument, OnNewGrantPostedQuery } from '../../generated/graphql'
			...
			for(const applicant of results.grantApplications) {
				const email = {
					...
					replacementData: JSON.stringify({
						...
						grantLink: getDomain(chainId) + `/explore_grants/about_grant/?grantId=${grant.id}&chainId=${chainId}`,
